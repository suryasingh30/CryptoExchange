(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/app_09170f._.js", {
...
const BidTable = ({ bids })=>{
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        children: data.map(([price, qty, total])=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(OrderRow, {
                price: price,
                quantity: qty,
                total: total,
                maxTotal: maxTotal,
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "Depth.useEffect": ()=>{
            const handleDepthUpdate = {
                "Depth.useEffect.handleDepthUpdate": (data)=>{
                    pendingRef.current = {
                        bids: data.b,
                        asks: data.a
                    };
                    if (!throttleRef.current) {
                        throttleRef.current = setTimeout({
                            "Depth.useEffect.handleDepthUpdate": ()=>{
                                const update = pendingRef.current;
                                if (update) {
                                    setBids({
                                        "Depth.useEffect.handleDepthUpdate": (prev)=>mergeOrders(prev, update.bids, true)
                                    }["Depth.useEffect.handleDepthUpdate"]);
                                    setAsks({
                                        "Depth.useEffect.handleDepthUpdate": (prev)=>mergeOrders(prev, update.asks, false)
                                    }["Depth.useEffect.handleDepthUpdate"]);
                                }
                                pendingRef.current = null;
                                throttleRef.current = null;
                            }
                        }["Depth.useEffect.handleDepthUpdate"], 1000); // Throttle update every 1s
                    }
                }
            }["Depth.useEffect.handleDepthUpdate"];
            const signaling = __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$utils$2f$SignalingManager$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["SignalingManager"].getInstance();
...
_s(Depth, "iaT9fSchTd1EcPl7RSq9I14jU3U=");
_c = Depth;
const TableHeader = ()=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
//# sourceMappingURL=app_09170f._.js.map