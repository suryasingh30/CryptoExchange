...
async function handler(req, res) {
    ...
    if (!symbol || typeof symbol !== "string") return res.status(400).json({
        error: "Missing or invalid market"
    });
    try {
        const response = await __TURBOPACK__imported__module__$5b$externals$5d2f$axios__$5b$external$5d$__$28$axios$2c$__esm_import$29$__["default"].get(`${BASE_URL}/trades`, {
            params: {
                symbol
            }
        });
...
var __TURBOPACK__imported__module__$5b$project$5d2f$pages$2f$api$2f$trades$2e$ts__$5b$api$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/pages/api/trades.ts [api] (ecmascript)");
var __turbopack_async_dependencies__ = __turbopack_handle_async_dependencies__([
    __TURBOPACK__imported__module__$5b$project$5d2f$pages$2f$api$2f$trades$2e$ts__$5b$api$5d$__$28$ecmascript$29$__
]);
([__TURBOPACK__imported__module__$5b$project$5d2f$pages$2f$api$2f$trades$2e$ts__$5b$api$5d$__$28$ecmascript$29$__] = __turbopack_async_dependencies__.then ? (await __turbopack_async_dependencies__)() : __turbopack_async_dependencies__);
;
;
;
;
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__4c2e85._.js.map